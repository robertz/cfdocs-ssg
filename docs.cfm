...
<cfoutput>
	...
	<div class="jumbotron">
		<div class="container" data-doc="#encodeForHTMLAttribute(prc.name)#">
			...
			<cfif StructKeyExists(prc, "discouraged") AND Len(prc.discouraged)>
				<div class="alert alert-danger">
					<h4><span class="glyphicon glyphicon-warning-sign"></span> Discouraged: #encodeForHTML(prc.discouraged)#</h4>
				</div>
			</cfif>
	...
	<cfif prc.type IS NOT "404" AND prc.type IS NOT "index">
		<ol class="breadcrumb container">
			...
			<cfif prc.type IS "function" OR url.name contains "-functions"><li><a href="#linkTo("functions")#">Functions</a></li></cfif>
			<cfif prc.type IS "tag" OR url.name contains "-tags"><li><a href="#linkTo("tags")#">Tags</a></li></cfif>
